...
?>
<h2 class="sub-header"><em>Список каналов выхода</em></h2>
		    			...
		    			<table class='table table-hover table-responsive table-condensed table-bordered' id='contract_table'>
		    				<thead>
		    					<tr>
				    				...
				    				<th style = 'cursor: pointer;'><center>Цена за слово</center></th>
			    			...
			    			<tbody>
<?php
$query = mysql_query("SELECT * FROM channel ORDER BY date_create");
